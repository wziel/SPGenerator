...
{
    [TestClass]
    public class FalseBooleanDataGeneratorUnitTests
    {
        FalseBooleanDataGenerator generator;

        [TestInitialize]
        public void TestInitialize()
        {
            generator = new FalseBooleanDataGenerator();
        }
        ...
        [TestMethod]
        public void GenerateData_ReturnsFalseOnly()
        {
            //given
            var recordsCount = 123;
            //when
