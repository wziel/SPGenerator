...
namespace SPGenerator.Tests.Generator.ColumnDataGenerator.MultilineText
{
    [TestClass]
    public class MultilineTextDataGeneratorUnitTests
    {
        ITextDAO mockTextDAO;
        MultilineTextDataGenerator generator;
        ...
        public void TestInitialize()
        {
            ...
            generator = new MultilineTextDataGenerator(mockTextDAO);
        }
        ...
        {
            //given
            var columnPOCO = new MultilineTextColumnPOCO() { GenerateData = true };
            //then
        ...
        {
            //given
            var columnPOCO = new MultilineTextColumnPOCO() { GenerateData = false };
            //then
